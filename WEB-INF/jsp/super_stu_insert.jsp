...
<div class="panel panel-info pull-right" style="width: 100%">
    ...
    <div class="panel-body">
        <div>
            <form class="form-inline" enctype="multipart/form-data" action="${pageContext.request.contextPath}/student/insert" method="post">
                    ...
                    <tr>
                        ...
                        <td style="width: 60%;">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="major" id="major" placeholder="">
                            </div>
                            <div class="form-group">
