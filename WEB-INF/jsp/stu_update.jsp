                    ...
                    <tr>
                        ...
                        <td style="width: 60%;">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" readonly="readonly" name="sno" id="sno" value="${user.sno}">
                            </div><br><br>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="roomid" id="roomid" value="${user.roomid}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="clase" id="clase" value="${user.clase}">
                            </div>
                            <div class="form-group">
                                <label for="inroom">是否在宿舍</label>
                                <input type="text" class="form-control" readonly="readonly" name="inroom" id="inroom" value="${user.inroom}">
                            </div>
                            <br><br>

                        </td>
                        <td><img src="${pageContext.request.contextPath}/${user.photo}" id="img0" style="width: 20rem;height: 15rem;"><br>
